              ...
              <div class="row no-gutters">
                <div class="col-12 col-md-5 col-lg-6">
                  <div class="pt-gallery">
                    <div class="pt-gallery-single-img">
                      <img
                    ...
                    <div class="pt-gallery-carousel-wrapper">
                      <ul class="pt-gallery-carousel">
                        ...
                        <li>
                          <a href="#">
                            <img
                              src="images/product/product-01-03.jpg"
                              alt=""
                            />
                          </a>
                        </li>
                        ...
                        <li>
                          <a href="#">
                            <img
                              src="images/product/product-01-05.jpg"
                              alt=""
                            />
                          </a>
                        </li>
                        <li>
                          <a href="#">
                            <img
                              src="images/product/product-01-06.jpg"
                              alt=""
                            />
                          </a>
                        </li>
                        <li>
                          <a href="#">
                            <img
                              src="images/product/product-01-07.jpg"
                              alt=""
                            />
                          </a>
                        </li>
                ...
                <div class="col-12 col-md-7 col-lg-6">
                  <div class="pt-product-single-info">
                    ...
                    <div class="pt-review">
                      ...
                      <a href="#" class="btn-link btn-lg pt-color-base">
                        <span class="pt-text">2 reviews</span>
                      </a>
                    </div>
                    <div class="pt-add-info">
                      <ul>
                        ...
                        <li>
                          <span>Vendor:</span> <a href="page404.html">Levis</a>
                        </li>
                        <li>
                          <span>Product Type:</span>{' '}
                          <a href="page404.html">Shirt</a>
                        </li>
                      </ul>
                    </div>
                    <div class="pt-swatches-container">
                      <div class="pt-wrapper">
                        ...
                        <ul class="pt-options-swatch">
                          <li class="active">
                            <a
                              style="background-image: url(images/product/product-01-02.jpg)"
                              href="#"
                          ...
                          <li>
                            <a
                              href="#"
                              class="options-color-img"
                              style="background-image:url(images/product/product-01-06.jpg)"
                            ></a>
                          </li>
                        </ul>
                      </div>
                      <div class="pt-wrapper">
                        ...
                        <ul class="pt-options-swatch size-middle">
                          ...
                          <li data-variant_availability="false">
                            <a href="#">L</a>
                          </li>
                          <li>
                            <a href="#">XL</a>
                    ...
                    <div class="pt-wrapper">
                      <a
                        href="product-type-01.html"
                        class="btn-link pt-color-base"
                      >
                        <span class="pt-text">View full info</span>
                      </a>
                    </div>
                  </div>
                </div>
